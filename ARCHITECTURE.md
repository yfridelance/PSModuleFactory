# ARCHITECTURE.md -- yvfrii.PS.ModuleFactory
...
**yvfrii.PS.ModuleFactory** is a PowerShell module that helps developers build, package, and
...
|
+-- yvfrii.PS.ModuleFactory/                  # Module root (importable module)
|   +-- yvfrii.PS.ModuleFactory.psd1          # Module manifest
|   +-- yvfrii.PS.ModuleFactory.psm1          # Dev: dot-sources | Build: merged
|   |
...
|       +-- yvfrii.PS.ModuleFactory.psd1
|       +-- yvfrii.PS.ModuleFactory.psm1
|
...
- The importable module lives in `yvfrii.PS.ModuleFactory/` (one level down from repo root).
...
#
# Module: <ModuleName>
# Generated by yvfrii.PS.ModuleFactory
...
yvfrii.PS.ModuleFactory does **not** use configuration files (no `.modulefactory.json`, no
...
### 9.10 Why the module folder is nested (repo/yvfrii.PS.ModuleFactory/) instead of at root?
...
- `Import-Module ./yvfrii.PS.ModuleFactory` works cleanly.
...
These are the conventions that yvfrii.PS.ModuleFactory enforces when creating or splitting
module files:
